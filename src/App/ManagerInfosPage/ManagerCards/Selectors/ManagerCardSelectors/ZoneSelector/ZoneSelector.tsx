...
export function ZoneSelector(props: any) {
    ...
    //STYLE BUTTONS
    const [styleAllButton, setStyleAllButton] = useState<'contained'|'outlined'>('contained')
    const [styleChampionEuropeButton, setStyleChampionEuropeButton] = useState<'contained'|'outlined'>('outlined')
    const [styleChallengerEuropeButton, setStyleChallengerEuropeButton] = useState<'contained'|'outlined'>('outlined')
    const [styleChampionAmericaButton, setStyleChampionAmericaButton] = useState<'contained'|'outlined'>('outlined')
    const [styleChampionAsiaButton, setStyleChampionAsiaButton] = useState<'contained'|'outlined'>('outlined')
